...
<head>
    ...
    <link rel="stylesheet" href="css/prosesservice.css">
...
<div class="page">
    ...
    <div class="page-top">
        <div>
            <div class="page-title">Proses Service</div>
            <div class="page-sub">
                Data proses perbaikan barang service
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="td-actions">
                            <a href="update_service.php?id=<?= $row['id_barang']; ?>" class="btn-edit">
                                Update Service
                            </a>
                        </div>
                    </td>
